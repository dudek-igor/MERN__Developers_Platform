...
const CreateProfile = ({ profile, createAndEditProfile }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    createAndEditProfile(formData, history);
  };
  if (profile) {
...
export default connect(mapStateToProps, { createAndEditProfile })(
  CreateProfile
);
